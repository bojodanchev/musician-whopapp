...
export default function Home() {
  return (
    <main className="min-h-screen bg-[#0b0b12] text-white">
      ...
      {/* Transformation – match dark embed styling */}
      ...
      <section id="pricing" className="mx-auto max-w-6xl px-4 pb-24">
        <div className="text-center mb-8">
          ...
          <p className="text-white/60 text-xs mt-2">Flexible payment options available: Pay monthly or choose from 100+ payment methods including Klarna, Afterpay, and installment plans</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <PlanCard plan="STARTER" title="Starter" price="$29/mo" features={["150 credits/mo","30s max loops","Loops only"]} generateHref="/generate" />
          <PlanCard plan="PRO" title="Pro" price="$79/mo" features={["600 credits/mo","Batch up to 10","Stems + streaming preview"]} generateHref="/generate" />
          <PlanCard plan="STUDIO" title="Studio" price="$199/mo" features={["2000 credits/mo","Team seats (x5)","Webhooks & API"]} generateHref="/generate" />
        </div>
      </section>
